...
Объезд идёт рысью: в ползании шаг вбок 1 см/с, и робот при этом разворачивается. Если нужный сдвиг больше 0,6 м (стена), объезда нет, робот стоит. Параметры: `perception.guard_avoid*`.
