...
| Файл | Что внутри |
|---|---|
| [index.html](index.html) | Полный цикл: тесты, калибровка по камере, ровный пол, уклоны и неровности с IMU и без, удержание курса, движение по дуге, пределы. 27 роликов |
...
| [gaits.html](gaits.html) | Походки: ползание (ступени, брус, лестница), стоп у стены, объезд блока, приветствие, осмотр. 8 роликов |
