"""
Simulation launch file for dog_control_cpp
...
def generate_launch_description():
    ...
    # IMU Simulator Node (regular node, not lifecycle)
    imu_simulator = Node(
    ...
    return LaunchDescription([
        LogInfo(msg="Starting Dog Control Simulation..."),
        LogInfo(msg="Launching IMU Simulator, Gait Controller, and Balance Controller"),
